      ...
      000062                        371 00103$:
                                    ...
                                    373 ;	assignBit
      000062 D2 95            [12]  374 	setb	_P1_5
                                    375 ;	main.c:10: for(i=0;i<3000;i++);
      000064 75 08 B8         [24]  376 	mov	_i,#0xb8
      000067 75 09 0B         [24]  377 	mov	(_i + 1),#0x0b
      00006A                        378 00107$:
      00006A 15 08            [12]  379 	dec	_i
      00006C 74 FF            [12]  380 	mov	a,#0xff
      00006E B5 08 02         [24]  381 	cjne	a,_i,00122$
      000071 15 09            [12]  382 	dec	(_i + 1)
      000073                        383 00122$:
      000073 E5 08            [12]  384 	mov	a,_i
      000075 45 09            [12]  385 	orl	a,(_i + 1)
      000077 70 F1            [24]  386 	jnz	00107$
      000079 75 08 B8         [24]  387 	mov	_i,#0xb8
      00007C 75 09 0B         [24]  388 	mov	(_i + 1),#0x0b
                                    389 ;	main.c:12: }
      00007F 80 E1            [24]  390 	sjmp	00103$
                                    391 	.area CSEG    (CODE)
                                    392 	.area CONST   (CODE)
                                    393 	.area XINIT   (CODE)
