      ...
      00006D D2 AF            [12]  375 	setb	_EA
                                    376 ;	main.c:7: TR0=1;		//打开定时器
                                    377 ;	assignBit
      00006F D2 8C            [12]  378 	setb	_TR0
                                    379 ;	main.c:8: ET0=1;		//打开定时器0中断
                                    380 ;	assignBit
      000071 D2 A9            [12]  381 	setb	_ET0
                                    382 ;	main.c:9: TMOD=0x01;	//选择为定时器0模式，工作方式1，仅用TR0打开启动。
      000073 75 89 01         [24]  383 	mov	_TMOD,#0x01
                                    384 ;	main.c:11: TH0=0xfc;	//1111 1100
      000076 75 8C FC         [24]  385 	mov	_TH0,#0xfc
                                    386 ;	main.c:12: TL0=0x18;	//0001 1000
      000079 75 8A 18         [24]  387 	mov	_TL0,#0x18
                                    388 ;	main.c:13: while(1);
      00007C                        389 00102$:
                                    390 ;	main.c:14: }
      00007C 80 FE            [24]  391 	sjmp	00102$
                                    ...
                                    396 ;------------------------------------------------------------
                                    397 ;	main.c:17: void Timer0() __interrupt 1		//定时器函数
                                    398 ;	-----------------------------------------
                                    399 ;	 function Timer0
                                    400 ;	-----------------------------------------
      00007E                        401 _Timer0:
      ...
      000080 C0 D0            [24]  403 	push	psw
                                    404 ;	main.c:20: TH0=0xfc;	//1111 1100
      000082 75 8C FC         [24]  405 	mov	_TH0,#0xfc
                                    406 ;	main.c:21: TL0=0x18;	//0001 1000
