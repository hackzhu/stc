      ...
      000000 02 00 29         [24]  325 	ljmp	__sdcc_gsinit_startup
      ...
      00001C                        333 	.ds	7
      000023 02 00 A0         [24]  334 	ljmp	_Usart
                                    335 ;--------------------------------------------------------
      ...
      000082 02 00 26         [24]  349 	ljmp	__sdcc_program_startup
                                    350 ;--------------------------------------------------------
                                    351 ; Home
                                    352 ;--------------------------------------------------------
                                    353 	.area HOME    (CODE)
      ...
      000026 02 00 85         [24]  356 	ljmp	_main
      ...
      000085 12 00 8A         [24]  379 	lcall	_UsartInit
                                    380 ;	main.c:8: while(1);
      000088                        381 00102$:
                                    382 ;	main.c:9: }
      000088 80 FE            [24]  383 	sjmp	00102$
                                    384 ;------------------------------------------------------------
                                    ...
                                    390 ;	-----------------------------------------
      00008A                        391 _UsartInit:
                                    392 ;	main.c:13: EA=1;		//打开中断总开关;
                                    393 ;	assignBit
      00008A D2 AF            [12]  394 	setb	_EA
                                    395 ;	main.c:14: ES=1;		//串口中断使能
                                    396 ;	assignBit
      00008C D2 AC            [12]  397 	setb	_ES
                                    398 ;	main.c:15: TMOD=0X20;	//设置计数器1工作方式2
      00008E 75 89 20         [24]  399 	mov	_TMOD,#0x20
                                    400 ;	main.c:16: TR1=1;		//打开计数器1
                                    401 ;	assignBit
      000091 D2 8E            [12]  402 	setb	_TR1
                                    403 ;	main.c:17: TH1=0XF3;	//计数器初始值设置，注意波特率是4800的
      000093 75 8D F3         [24]  404 	mov	_TH1,#0xf3
                                    405 ;	main.c:18: TL1=0XF3;
      000096 75 8B F3         [24]  406 	mov	_TL1,#0xf3
                                    407 ;	main.c:19: SCON=0X50;	//SM0=0;SM=1;设置为工作方式1   0101 0000
      000099 75 98 50         [24]  408 	mov	_SCON,#0x50
                                    409 ;	main.c:23: PCON=0X80;	//波特率加倍 1000 0000
      00009C 75 87 80         [24]  410 	mov	_PCON,#0x80
                                    411 ;	main.c:25: }
      00009F 22               [24]  412 	ret
                                    413 ;------------------------------------------------------------
                                    ...
                                    421 ;	-----------------------------------------
      0000A0                        422 _Usart:
      0000A0 C0 07            [24]  423 	push	ar7
      0000A2 C0 D0            [24]  424 	push	psw
      0000A4 75 D0 00         [24]  425 	mov	psw,#0x00
                                    426 ;	main.c:30: receiveData=SBUF;	//出去接收到的数据
      0000A7 AF 99            [24]  427 	mov	r7,_SBUF
                                    428 ;	main.c:31: RI = 0;			//清除接收中断标志位
                                    429 ;	assignBit
      0000A9 C2 98            [12]  430 	clr	_RI
                                    431 ;	main.c:32: SBUF=receiveData;	//将接收到的数据放入到发送寄存器
      0000AB 8F 99            [24]  432 	mov	_SBUF,r7
                                    433 ;	main.c:33: while(!TI);		//等待发送数据完成
      0000AD                        434 00101$:
                                    435 ;	main.c:34: TI=0;			//清除发送完成标志位
                                    436 ;	assignBit
      0000AD 10 99 02         [24]  437 	jbc	_TI,00114$
      0000B0 80 FB            [24]  438 	sjmp	00101$
      0000B2                        439 00114$:
                                    440 ;	main.c:35: }
      0000B2 D0 D0            [24]  441 	pop	psw
      0000B4 D0 07            [24]  442 	pop	ar7
      0000B6 32               [24]  443 	reti
