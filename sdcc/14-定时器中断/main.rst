      ...
      000004                        329 	.ds	7
      00000B 02 00 7D         [24]  330 	ljmp	_Timer0
                                    331 ;--------------------------------------------------------
      ...
      00000E 02 00 A5         [24]  352 	ljmp	_main
      ...
      00006D                        365 _Timer0Init:
                           ...
                           000000   373 	ar0 = 0x00
                                    ...
                                    375 ;	assignBit
      00006D D2 AF            [12]  376 	setb	_EA
                                    377 ;	main.c:7: TMOD=0x01;	//选择为定时器0模式，工作方式1，仅用TR0打开启动。
      00006F 75 89 01         [24]  378 	mov	_TMOD,#0x01
                                    379 ;	main.c:12: TR0=1;		//打开定时器
                                    380 ;	assignBit
      000072 D2 8C            [12]  381 	setb	_TR0
                                    382 ;	main.c:13: ET0=1;		//打开定时器0中断
                                    383 ;	assignBit
      000074 D2 A9            [12]  384 	setb	_ET0
                                    385 ;	main.c:17: TH0=0xfc;	//1111 1100
      000076 75 8C FC         [24]  386 	mov	_TH0,#0xfc
                                    387 ;	main.c:18: TL0=0x18;	//0001 1000
      000079 75 8A 18         [24]  388 	mov	_TL0,#0x18
                                    389 ;	main.c:19: }
      00007C 22               [24]  390 	ret
                                    ...
                                    399 ;	-----------------------------------------
      00007D                        400 _Timer0:
      00007D C0 E0            [24]  401 	push	acc
      00007F C0 D0            [24]  402 	push	psw
                                    403 ;	main.c:25: TH0=0xfc;	//1111 1100
      000081 75 8C FC         [24]  404 	mov	_TH0,#0xfc
                                    405 ;	main.c:26: TL0=0x18;	//0001 1000
      000084 75 8A 18         [24]  406 	mov	_TL0,#0x18
                                    407 ;	main.c:27: i++;
      000087 05 08            [12]  408 	inc	_Timer0_i_65536_2
      000089 E4               [12]  409 	clr	a
      00008A B5 08 02         [24]  410 	cjne	a,_Timer0_i_65536_2,00109$
      00008D 05 09            [12]  411 	inc	(_Timer0_i_65536_2 + 1)
      00008F                        412 00109$:
                                    413 ;	main.c:28: if(i==1000)
      00008F 74 E8            [12]  414 	mov	a,#0xe8
      000091 B5 08 0C         [24]  415 	cjne	a,_Timer0_i_65536_2,00103$
      000094 74 03            [12]  416 	mov	a,#0x03
      000096 B5 09 07         [24]  417 	cjne	a,(_Timer0_i_65536_2 + 1),00103$
                                    418 ;	main.c:30: i=0;
      000099 E4               [12]  419 	clr	a
      00009A F5 08            [12]  420 	mov	_Timer0_i_65536_2,a
      00009C F5 09            [12]  421 	mov	(_Timer0_i_65536_2 + 1),a
                                    422 ;	main.c:31: P2_0=!P2_0;
      00009E B2 A0            [12]  423 	cpl	_P2_0
      0000A0                        424 00103$:
                                    425 ;	main.c:33: }
      0000A0 D0 D0            [24]  426 	pop	psw
      0000A2 D0 E0            [24]  427 	pop	acc
      0000A4 32               [24]  428 	reti
      ...
      0000A5 12 00 6D         [24]  442 	lcall	_Timer0Init
                                    443 ;	main.c:39: while(1);
      0000A8                        444 00102$:
                                    445 ;	main.c:40: }
      0000A8 80 FE            [24]  446 	sjmp	00102$
                                    447 	.area CSEG    (CODE)
                                    448 	.area CONST   (CODE)
                                    449 	.area XINIT   (CODE)
