      ...
      000003 02 00 62         [24]  346 	ljmp	_main
                                    ...
                                    356 ;j                         Allocated to registers r4 r5 
                                    357 ;------------------------------------------------------------
      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	main.c:7: for(i=0;i<30000;i++);
      000062 7E 30            [12]  372 	mov	r6,#0x30
      000064 7F 75            [12]  373 	mov	r7,#0x75
      000066                        374 00109$:
      000066 1E               [12]  375 	dec	r6
      000067 BE FF 01         [24]  376 	cjne	r6,#0xff,00148$
      00006A 1F               [12]  377 	dec	r7
      00006B                        378 00148$:
      00006B EE               [12]  379 	mov	a,r6
      00006C 4F               [12]  380 	orl	a,r7
      00006D 70 F7            [24]  381 	jnz	00109$
      00006F 7E 30            [12]  382 	mov	r6,#0x30
      000071 7F 75            [12]  383 	mov	r7,#0x75
                                    384 ;	main.c:10: for(j=0;j<8;j++)
      000073                        385 00121$:
      000073 7C 00            [12]  386 	mov	r4,#0x00
      000075 7D 00            [12]  387 	mov	r5,#0x00
      000077                        388 00113$:
                                    389 ;	main.c:12: P2=0xfe<<i;
      000077 8E 03            [24]  390 	mov	ar3,r6
      000079 8B F0            [24]  391 	mov	b,r3
      00007B 05 F0            [12]  392 	inc	b
      00007D 74 FE            [12]  393 	mov	a,#0xfe
      00007F 80 02            [24]  394 	sjmp	00152$
      000081                        395 00150$:
      000081 25 E0            [12]  396 	add	a,acc
      000083                        397 00152$:
      000083 D5 F0 FB         [24]  398 	djnz	b,00150$
      000086 F5 A0            [12]  399 	mov	_P2,a
                                    400 ;	main.c:13: for(i=0;i<60000;i++);
      000088 7A 60            [12]  401 	mov	r2,#0x60
      00008A 7B EA            [12]  402 	mov	r3,#0xea
      00008C                        403 00112$:
      00008C 1A               [12]  404 	dec	r2
      00008D BA FF 01         [24]  405 	cjne	r2,#0xff,00153$
      000090 1B               [12]  406 	dec	r3
      000091                        407 00153$:
      000091 EA               [12]  408 	mov	a,r2
      000092 4B               [12]  409 	orl	a,r3
      000093 70 F7            [24]  410 	jnz	00112$
      000095 7E 60            [12]  411 	mov	r6,#0x60
      000097 7F EA            [12]  412 	mov	r7,#0xea
                                    413 ;	main.c:10: for(j=0;j<8;j++)
      000099 0C               [12]  414 	inc	r4
      00009A BC 00 01         [24]  415 	cjne	r4,#0x00,00155$
      00009D 0D               [12]  416 	inc	r5
      00009E                        417 00155$:
      00009E C3               [12]  418 	clr	c
      00009F EC               [12]  419 	mov	a,r4
      0000A0 94 08            [12]  420 	subb	a,#0x08
      0000A2 ED               [12]  421 	mov	a,r5
      0000A3 94 00            [12]  422 	subb	a,#0x00
      0000A5 40 D0            [24]  423 	jc	00113$
                                    424 ;	main.c:16: }
      0000A7 80 CA            [24]  425 	sjmp	00121$
                                    426 	.area CSEG    (CODE)
                                    427 	.area CONST   (CODE)
                                    428 	.area XINIT   (CODE)
