      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	main.c:6: P2=0xfe;
      000062 75 A0 FE         [24]  372 	mov	_P2,#0xfe
                                    373 ;	main.c:7: for(i=0;i<30000;i++);
      000065 7E 30            [12]  374 	mov	r6,#0x30
      000067 7F 75            [12]  375 	mov	r7,#0x75
      000069                        376 00109$:
      000069 1E               [12]  377 	dec	r6
      00006A BE FF 01         [24]  378 	cjne	r6,#0xff,00145$
      00006D 1F               [12]  379 	dec	r7
      00006E                        380 00145$:
      00006E EE               [12]  381 	mov	a,r6
      00006F 4F               [12]  382 	orl	a,r7
      000070 70 F7            [24]  383 	jnz	00109$
                                    384 ;	main.c:10: for(j=0;j<8;j++)
      000072                        385 00121$:
      000072 7E 00            [12]  386 	mov	r6,#0x00
      000074 7F 00            [12]  387 	mov	r7,#0x00
      000076                        388 00113$:
                                    389 ;	main.c:12: P2>>=3;
      000076 E5 A0            [12]  390 	mov	a,_P2
      000078 C4               [12]  391 	swap	a
      000079 23               [12]  392 	rl	a
      00007A 54 1F            [12]  393 	anl	a,#0x1f
      00007C F5 A0            [12]  394 	mov	_P2,a
                                    395 ;	main.c:13: for(i=0;i<30000;i++);
      00007E 7C 30            [12]  396 	mov	r4,#0x30
      000080 7D 75            [12]  397 	mov	r5,#0x75
      000082                        398 00112$:
      000082 1C               [12]  399 	dec	r4
      000083 BC FF 01         [24]  400 	cjne	r4,#0xff,00147$
      000086 1D               [12]  401 	dec	r5
      000087                        402 00147$:
      000087 EC               [12]  403 	mov	a,r4
      000088 4D               [12]  404 	orl	a,r5
      000089 70 F7            [24]  405 	jnz	00112$
                                    406 ;	main.c:10: for(j=0;j<8;j++)
      00008B 0E               [12]  407 	inc	r6
      00008C BE 00 01         [24]  408 	cjne	r6,#0x00,00149$
      00008F 0F               [12]  409 	inc	r7
      000090                        410 00149$:
      000090 C3               [12]  411 	clr	c
      000091 EE               [12]  412 	mov	a,r6
      000092 94 08            [12]  413 	subb	a,#0x08
      000094 EF               [12]  414 	mov	a,r7
      000095 94 00            [12]  415 	subb	a,#0x00
      000097 40 DD            [24]  416 	jc	00113$
                                    417 ;	main.c:16: }
      000099 80 D7            [24]  418 	sjmp	00121$
                                    419 	.area CSEG    (CODE)
                                    420 	.area CONST   (CODE)
                                    421 	.area XINIT   (CODE)
