      ...
      000003 02 00 62         [24]  346 	ljmp	_main
                                    ...
                                    356 ;j                         Allocated to registers r6 r7 
                                    357 ;------------------------------------------------------------
      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	main.c:8: for(i=0;i<30000;i++);
      000062 7E 30            [12]  372 	mov	r6,#0x30
      000064 7F 75            [12]  373 	mov	r7,#0x75
      000066                        374 00109$:
      000066 1E               [12]  375 	dec	r6
      000067 BE FF 01         [24]  376 	cjne	r6,#0xff,00145$
      00006A 1F               [12]  377 	dec	r7
      00006B                        378 00145$:
      00006B EE               [12]  379 	mov	a,r6
      00006C 4F               [12]  380 	orl	a,r7
      00006D 70 F7            [24]  381 	jnz	00109$
                                    382 ;	main.c:11: for(j=0;j<8;j++)
      00006F                        383 00121$:
      00006F 7E 00            [12]  384 	mov	r6,#0x00
      000071 7F 00            [12]  385 	mov	r7,#0x00
      000073                        386 00113$:
                                    387 ;	main.c:13: LED=0xff<<j;	//11111111 ...--> 11110000 ...--> 00000000
      000073 8E 05            [24]  388 	mov	ar5,r6
      000075 8D F0            [24]  389 	mov	b,r5
      000077 05 F0            [12]  390 	inc	b
      000079 74 FF            [12]  391 	mov	a,#0xff
      00007B 80 02            [24]  392 	sjmp	00149$
      00007D                        393 00147$:
      00007D 25 E0            [12]  394 	add	a,acc
      00007F                        395 00149$:
      00007F D5 F0 FB         [24]  396 	djnz	b,00147$
      000082 F5 A0            [12]  397 	mov	_P2,a
                                    398 ;	main.c:14: for(i=0;i<30000;i++);
      000084 7C 30            [12]  399 	mov	r4,#0x30
      000086 7D 75            [12]  400 	mov	r5,#0x75
      000088                        401 00112$:
      000088 1C               [12]  402 	dec	r4
      000089 BC FF 01         [24]  403 	cjne	r4,#0xff,00150$
      00008C 1D               [12]  404 	dec	r5
      00008D                        405 00150$:
      00008D EC               [12]  406 	mov	a,r4
      00008E 4D               [12]  407 	orl	a,r5
      00008F 70 F7            [24]  408 	jnz	00112$
                                    409 ;	main.c:11: for(j=0;j<8;j++)
      000091 0E               [12]  410 	inc	r6
      000092 BE 00 01         [24]  411 	cjne	r6,#0x00,00152$
      000095 0F               [12]  412 	inc	r7
      000096                        413 00152$:
      000096 C3               [12]  414 	clr	c
      000097 EE               [12]  415 	mov	a,r6
      000098 94 08            [12]  416 	subb	a,#0x08
      00009A EF               [12]  417 	mov	a,r7
      00009B 94 00            [12]  418 	subb	a,#0x00
      00009D 40 D4            [24]  419 	jc	00113$
                                    420 ;	main.c:17: }
      00009F 80 CE            [24]  421 	sjmp	00121$
                                    422 	.area CSEG    (CODE)
                                    423 	.area CONST   (CODE)
                                    424 	.area XINIT   (CODE)
