      ...
      000062                        361 _main:
                           ...
                           000001   368 	ar1 = 0x01
                           000000   369 	ar0 = 0x00
                                    370 ;	main.c:8: while(1)
      000062                        371 00104$:
                                    372 ;	main.c:10: LED8=1;
                                    373 ;	assignBit
      000062 D2 A7            [12]  374 	setb	_P2_7
                                    375 ;	main.c:11: for(i=0;i<30000;i++);	//延时函数
      000064 7E 30            [12]  376 	mov	r6,#0x30
      000066 7F 75            [12]  377 	mov	r7,#0x75
      000068                        378 00108$:
      000068 1E               [12]  379 	dec	r6
      000069 BE FF 01         [24]  380 	cjne	r6,#0xff,00136$
      00006C 1F               [12]  381 	dec	r7
      00006D                        382 00136$:
      00006D EE               [12]  383 	mov	a,r6
      00006E 4F               [12]  384 	orl	a,r7
      00006F 70 F7            [24]  385 	jnz	00108$
                                    386 ;	main.c:12: LED8=0;
                                    387 ;	assignBit
      000071 C2 A7            [12]  388 	clr	_P2_7
                                    389 ;	main.c:13: for(i=0;i<30000;i++);
      000073 7E 30            [12]  390 	mov	r6,#0x30
      000075 7F 75            [12]  391 	mov	r7,#0x75
      000077                        392 00111$:
      000077 1E               [12]  393 	dec	r6
      000078 BE FF 01         [24]  394 	cjne	r6,#0xff,00138$
      00007B 1F               [12]  395 	dec	r7
      00007C                        396 00138$:
      00007C EE               [12]  397 	mov	a,r6
      00007D 4F               [12]  398 	orl	a,r7
      00007E 70 F7            [24]  399 	jnz	00111$
                                    400 ;	main.c:15: }
      000080 80 E0            [24]  401 	sjmp	00104$
                                    402 	.area CSEG    (CODE)
                                    403 	.area CONST   (CODE)
                                    404 	.area XINIT   (CODE)
