      ...
      000003 02 00 8A         [24]  347 	ljmp	_main
                                    ...
                                    357 ;a                         Allocated to registers r6 
                                    358 ;------------------------------------------------------------
                                    359 ;	main.c:10: void hc595(unsigned char dat)
                                    360 ;	-----------------------------------------
                                    361 ;	 function hc595
                                    362 ;	-----------------------------------------
      000062                        363 _hc595:
      ...
      000062 AF 82            [24]  372 	mov	r7,dpl
                                    373 ;	main.c:13: SRCLK=0;
                                    374 ;	assignBit
      000064 C2 B6            [12]  375 	clr	_P3_6
                                    376 ;	main.c:14: RCLK=0;
                                    377 ;	assignBit
      000066 C2 B5            [12]  378 	clr	_P3_5
                                    379 ;	main.c:15: for(a=0;a<8;a++)	//发送8位数
      000068 7E 00            [12]  380 	mov	r6,#0x00
      00006A                        381 00102$:
                                    382 ;	main.c:17: SER= dat >> 7;	//读取最高位	
      ...
      000089 22               [24]  420 	ret
                                    ...
                                    423 ;------------------------------------------------------------
                                    424 ;	main.c:31: void main()
                                    425 ;	-----------------------------------------
                                    426 ;	 function main
                                    427 ;	-----------------------------------------
      00008A                        428 _main:
                                    429 ;	main.c:33: LED1=0;		
                                    430 ;	assignBit
      00008A C2 87            [12]  431 	clr	_P0_7
                                    432 ;	main.c:34: while(1) hc595(0x80);
      00008C                        433 00102$:
      00008C 75 82 80         [24]  434 	mov	dpl,#0x80
      00008F 12 00 62         [24]  435 	lcall	_hc595
                                    436 ;	main.c:35: }
      000092 80 F8            [24]  437 	sjmp	00102$
                                    438 	.area CSEG    (CODE)
                                    439 	.area CONST   (CODE)
                                    440 	.area XINIT   (CODE)
