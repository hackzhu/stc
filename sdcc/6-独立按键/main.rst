      ...
      000003 02 00 74         [24]  347 	ljmp	_main
                                    ...
                                    357 ;------------------------------------------------------------
                                    358 ;	main.c:6: void delay(unsigned int i)
                                    359 ;	-----------------------------------------
                                    360 ;	 function delay
                                    361 ;	-----------------------------------------
      000062                        362 _delay:
      ...
      000073 22               [24]  385 	ret
                                    ...
                                    388 ;------------------------------------------------------------
                                    389 ;	main.c:12: void main()
                                    390 ;	-----------------------------------------
                                    391 ;	 function main
                                    392 ;	-----------------------------------------
      000074                        393 _main:
                                    394 ;	main.c:14: while(1)
      000074                        395 00109$:
                                    396 ;	main.c:16: if(KEY2==0)
      000074 20 B0 FD         [24]  397 	jb	_P3_0,00109$
                                    398 ;	main.c:18: delay(1000);
      000077 90 03 E8         [24]  399 	mov	dptr,#0x03e8
      00007A 12 00 62         [24]  400 	lcall	_delay
                                    401 ;	main.c:19: if(KEY2==0) LED1=!LED1;
      00007D 20 B0 02         [24]  402 	jb	_P3_0,00103$
      000080 B2 A0            [12]  403 	cpl	_P2_0
                                    404 ;	main.c:20: while(!KEY2);
      000082                        405 00103$:
      000082 30 B0 FD         [24]  406 	jnb	_P3_0,00103$
                                    407 ;	main.c:23: }
      000085 80 ED            [24]  408 	sjmp	00109$
                                    409 	.area CSEG    (CODE)
                                    410 	.area CONST   (CODE)
                                    411 	.area XINIT   (CODE)
